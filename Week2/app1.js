"use strict";
{
    ...
    function main(url){  
        ...
        .then(repositories => {
            ...
            const banner= createAppend('div',result,{id:'header'});
            createAppend('label',banner,{text:'HYF Repositories',id:'selectLabel'});
            createAppend('select',banner,{class:'rep-select', id:'selectID'});
            ...
            select.addEventListener('change', (event)=> {
                const repository = repositories[event.target.value];
                renderRepository(repoContainer,repository);
                createContainer(contContainer,repository)
            });                
