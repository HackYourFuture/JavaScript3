...
class View {
  ...
  async initialize(e) {
    const t = document.getElementById("root"),
      r = Util.createAndAppend("header", t, { class: "header" });
