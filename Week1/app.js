...
function main() {
    ...
    function renders(selectedRepository) {
        const url = 'https://api.github.com/repos/HackYourFuture/' + selectedRepository;
        const uc = 'https://api.github.com/repos/HackYourFuture/' + selectedRepository + '/contributors'
        fetchJSON(url, renderInformation);
        fetchJSON(uc, renderContributors);
    }
}
